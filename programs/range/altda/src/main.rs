//! A program to verify an Optimism L2 block STF with AltDA (Keccak256 commitment) in the zkVM.
//!
...
//!
//! AltDA mode handles chains where batch data is stored off-chain, with only commitments posted
//! to L1. The program resolves commitments to actual batch data via the host's preimage oracle.
